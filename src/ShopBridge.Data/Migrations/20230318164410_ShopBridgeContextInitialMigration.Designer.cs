...
namespace ShopBridge.Data.Migrations
{
    ...
    [Migration("20230318164410_ShopBridgeContextInitialMigration")]
    partial class ShopBridgeContextInitialMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProductsCategories", b =>
                {
                    ...
                    b.Property<int>("CategoryIdName")
                        .HasColumnType("int");

                    b.HasKey("ProductId", "CategoryIdName");

                    b.HasIndex("CategoryIdName");
